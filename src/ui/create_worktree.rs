...
impl CreateWorktreeScreen {
    ...
    pub fn handle_event(
        ...
        if key_event.modifiers == KeyModifiers::CONTROL {
            ...
            match self.mode {
                ScreenMode::Inserting => match key_event.code {
                    KeyCode::Esc => return HandleEventResult::NewScreen(Screen::ListRepos),
                    KeyCode::Tab => self.mode = ScreenMode::Confirming,
                ...
                ScreenMode::Confirming => match key_event.code {
